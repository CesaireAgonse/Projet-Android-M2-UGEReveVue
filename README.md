...
```
cd existing_repo
git remote add origin https://gitlab.com/VPerezLefeuvre/ugerevevue-android.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/VPerezLefeuvre/ugerevevue-android/-/settings/integrations)
